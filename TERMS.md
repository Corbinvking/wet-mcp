...
Use of the hosted service is governed by the current [W.E.T. Terms of Use](https://www.worldeventtrading.com/terms), [privacy policy](https://www.worldeventtrading.com/privacy), [limitations](https://www.worldeventtrading.com/limitations), and published [benchmark data licence](https://www.worldeventtrading.com/governance/data-licence).
...
This repository's files are licensed only under [`LICENSE`](LICENSE). Public visibility does not make the hosted implementation or W.E.T. datasets open source.
