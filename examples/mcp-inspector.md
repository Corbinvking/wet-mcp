...
After a future authorized release, the command performs a fresh connection, lists the anonymous tool inventory, and reports schema-portability findings. It is a reviewer/proof command, not a persistent client configuration and not evidence that the full v0.5.0 candidate was authorized or deployed.
