...
The six sourced/derived public tools currently return `source_rights_pending` under policy `mcp-source-rights/2026-09-05.phase1`; these quote rules do not claim current value availability.
